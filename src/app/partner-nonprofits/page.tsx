...
export const metadata: Metadata = {
  ...
  description:
    "Partner 501(c)(3) organizations serving children in foster care, kinship care, or crisis can request clothing, shoes, and essentials for a child in need, contributed directly to the partner.",
