...
export const PARTNER_REQUESTS = {
  ...
  stewardship:
    "These goods are given by our community and entrusted to our care. As part of our charitable mission, we contribute them to children in need through our partner nonprofit organizations. Nothing in this channel is sold.",
